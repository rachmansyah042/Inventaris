			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="read"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Lihat Data</span></a></li>	
						<li><a href="messages.html"><i class="icon-envelope"></i><span class="hidden-tablet"> Messages</span></a></li>
						<li><a href="inputdata"><i class="icon-tasks"></i><span class="hidden-tablet"> Input Data</span></a></li>
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<div class="content">
						...
						<div class="browserStat big">
							<img src="{{URL('assets/janux/img/browser-chrome-big.png')}}" alt="Chrome">
							<span>34%</span>
						</div>
						<div class="browserStat big">
							<img src="{{URL('assets/janux/img/browser-firefox-big.png')}}" alt="Firefox">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="{{URL('assets/janux/img/browser-ie.png')}}" alt="Internet Explorer">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="{{URL('assets/janux/img/browser-safari.png')}}" alt="Safari">
							<span>34%</span>
						</div>
						<div class="browserStat">
							<img src="{{URL('assets/janux/img/browser-opera.png')}}" alt="Opera">
							<span>34%</span>
						</div>	
